...
class Checkout extends Component {
    ...
    submitHandle = () => {
        ...
        axios.post("https://burger-builder-57520-default-rtdb.firebaseio.com/orders.json?auth=" + this.props.token, order) //jokhoni firebase e kaj korbo tokhn key er shes .json use korte hobe
            .then(response => {
